...
*      ENDIF.
      ...
      "! - Elabora solo i record con motivo blank (quantit� accettate)
      "! - Raggruppa i record per: vbeln, posnr, lfdat, matnr, charg, motivo
      "! - Somma le quantit� (qta_acc) per ogni gruppo
...
*      LOOP AT lt_det ASSIGNING FIELD-SYMBOL(<ls_item>).
      ...
      LOOP AT lt_det2 ASSIGNING FIELD-SYMBOL(<ls_item2>).
        ...
        "! Il controllo viene effettuato sul campo motivo che � l'ultimo nella SORT
        AT END OF motivo.
